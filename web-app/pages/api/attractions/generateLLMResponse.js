...
export default async function generateResponse(attractions_data, weather_data, user_info, city) {
    ...
    try {
        ...
        For each day in the json "+JSON.stringify(weather_data)+", select three attractions from attractions_data (without replacement) and assign them to the morning, afternoon, and night keys. \
        ...
        { 'day_1': { 'weather': {'high': '...', 'low': '...', 'condition': '...' }, morning': { 'title': '...', 'address': '...', 'description': '...', 'link_url': '...', 'imageLink': '...'}, \
         'afternoon': { 'title': '...', 'address': '...', 'description': '...', 'link_url': '...', 'imageLink': '...'}, \
