...
export default async function generateResponse(attractions_data, weather_data, user_input) {
    ...
    try {
        ...
        "+user_input.purpose_of_trip+", "+user_input.interests+", "+user_input.preferences+", "+user_input.other_info+". The format of the JSON must follow this structure: { 'day_1': { 'morning': { 'title': '...', 'address': '...', \
