    ...
    const mealComponent = (meal, mealData) => (
        <div
            className={`bg-white p-4 rounded-md shadow-md flex items-center cursor-pointer ${
                selectedMeal === meal ? 'bg-[#E2DCC8] border-2 border-[#E2DCC8]' : ''
            }`}
                    ...
                    {Array.from({ length: totalDays }, (_, index) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg ${
                                currentPlanIndex === index ? 'bg-[#E2DCC8] text-black' : 'bg-gray-300 text-black'
                            }`}
                        >
                            Day {index + 1}
                        </button>
                ...
                <div>
                    ...
                    {currentDay ? (
                        <div className="space-y-8">
                            <div className="bg-[#E2DCC8] p-6 rounded-lg shadow-lg flex items-center text-block">
                                <div className="flex-1">
